...
Please ask questions and make comments as we go through the material via the online shared document (Etherpad) at [https://v.etherpad.org/p/nimble-sbss-2016](https://v.etherpad.org/p/nimble-sbss-2016). You can also share ideas, code snippets, and error messages.
...
Here are the modules we'll work through for this workshop, though we probably won't get to all of them.
 ...
 - Programming in NIMBLE
    ...
    3. [Alternative parameterizations](alt_param_slides.html)
    4. [Writing an algorithm using nimbleFunctions](nimbleFunctions_slides.html)
 - Using nimbleFunctions in practice
    ...
    3. [Compiling R code](compiling_R_slides.html)
...
1. [Constants in BUGS code](constants_slides.html)
2. [Indexing](indexing_slides.html)
3. [Vectorizing BUGS code](vectorizing_slides.html)
4. [User-defined functions in BUGS code](user_function_slides.html)

...
The Github site ([https://github.com/paciorek/nimble-sbss-2016](https://github.com/paciorek/nimble-sbss-2016)) is the master repository for materials for the modules; you can also get the individual files from Github. 

To get the materials look ahead to slide 6 for instructions. Alternatively, simply go to [https://github.com/paciorek/nimble-sbss-2016](https://github.com/paciorek/nimble-sbss-2016) and click on the 'Download ZIP' button in the right side of the window or simply click [here](https://github.com/paciorek/nimble-sbss-2016/archive/master.zip).



## Asking questions and making comments

Please ask questions and make comments as we go through the material. You can also share ideas, code snippets, and error messages, as well as ask questions through an online shared document at [https://v.etherpad.org/p/nimble-sbss-2016](https://v.etherpad.org/p/nimble-sbss-2016).

# How we'll operate

The workshop will be organized in modules, each of which will be a combination of lecture/demo presentation, in some cases followed by a short breakout session in which you'll work on a variety of problems of different levels of difficulty. The idea is for each person to find problems that challenge them but are not too hard. 
...
Simply go to [https://github.com/paciorek/nimble-sbss-2016](https://github.com/paciorek/nimble-sbss-2016) and click on the 'Download ZIP' button in the right side of the window or simply click [here](https://github.com/paciorek/nimble-sbss-2016/archive/master.zip).

## Within RStudio

Within RStudio go to File->New Project->Version Control->Git and enter:

- "Repository URL": https://github.com/paciorek/nimble-sbss-2016
- "Project Directory Name": nimble-sbss-2016 (or something else of your choosing)
...
- `git clone https://github.com/paciorek/nimble-sbss-2016`

Then to update from the repository to get any changes we've made:

- `cd /directory/where/you/put/the/repository/nimble-sbss-2016`
- `git pull`
...
Exercises can be found [here](exercises_slides.html).
    
Other topics

1. [Vectorizing BUGS code](vectorizing_slides.html)
2. [Constants in BUGS code](constants_slides.html)
3. [User-defined functions in BUGS code](user_function_slides.html)
